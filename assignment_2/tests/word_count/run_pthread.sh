...
then
    ...
    -e cycles:u \
    -e instructions \
    ./word_count-pthread word_count_datafiles/word_10MB.txt 1 \
    && \
    printf "\n" \
    && \
    ...
    -e cycles:u \
    -e instructions \
    ./word_count-pthread word_count_datafiles/word_50MB.txt 1 \
    && \
    printf "\n" \
    &&
    ...
    -e cycles:u \
    -e instructions \
    ./word_count-pthread word_count_datafiles/word_100MB.txt 1
