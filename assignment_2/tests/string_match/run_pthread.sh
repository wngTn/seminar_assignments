...
then
    ...
    Page size (bytes): %Z" \
    ./string_match-pthread string_match_datafiles/key_file_50MB.txt \
    && \
    printf "\n" \
    && \
    ...
    Minor (reclaiming a frame) page faults: %R
    Page size (bytes): %Z" \
    ./string_match-pthread string_match_datafiles/key_file_100MB.txt \
    && \
    printf "\n" \
    &&
    ...
    Minor (reclaiming a frame) page faults: %R
    Page size (bytes): %Z" \
    ./string_match-pthread string_match_datafiles/key_file_500MB.txt
